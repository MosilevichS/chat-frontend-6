...
const ContactItem = ({
  ...
  return (
    <div className="h-[80px] px-2 py-1">
      <Link
        href={`/contacts/${contact.system_contact.uid}`}
        key={contact.uid}
        className={`flex items-center py-1.5 gap-x-2.5 min-w-[342px] h-[72px] cursor-pointer hover:bg-(--color-gray-2)
                   rounded-lg px-2 py-[15px]
      ...
      >
        ...
        <div className="flex justify-between relative h-[40px] after:absolute after:left-0 after:right-0 after:bottom-[-21px] after:border-b after:border-1 after:border-(--color-button-disabled) after:z--1 w-full">
          <div>
            <p
